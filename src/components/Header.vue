    ...
    <div class="header__right">
      <ul class="header__list">
        <li class="header__listItem">
          ...
          <span
            >{{ getTotalPrice.toLocaleString() }} руб.</span
          >
        </li>
        <li
          @click="$router.push('/favourites')"
          class="header__listItem">
          <span
            class="header__count"
            v-if="favoritesItems.length > 0"
            >{{ favoritesItems.length }}</span
          >
          <svg
            width="21"
            height="19"
